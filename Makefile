...
#================================================================================================
# Note:
# I don't want to commit to submodules or anything for now, so I will directly reference my
# repositories that are cloned locally.

include $(wildcard ../libmacros/*.mk)
